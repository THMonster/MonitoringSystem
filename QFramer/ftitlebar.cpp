...
void FTitleBar::initData()
{
    ...
    fixflag = false;
    maxIcon =  new QIcon(QString(":/image/skin/max.png"));
    normalIcon =  new QIcon(QString(":/image/skin/max.png"));
}
...
void FTitleBar::initUI()
{
    ...
    setTitleLabel(tr("监控系统"), "FTitleLabel");
    ...
    setMinButton(":/image/skin/min.png");
    setMaxButton(":/image/skin/max.png");
    setCloseButton(":/image/skin/close.png", "close");
